"""Docs: https://gpp-rnd.github.io/rs3/targetdata.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../01_targetdata.ipynb.

# %% auto #0
__all__ = ['ensembl_post', 'chunks', 'post_transcript_sequence_chunk', 'post_transcript_sequence', 'build_transcript_aa_seq_df',
           'ensembl_get', 'get_translation_overlap', 'build_translation_overlap_df', 'write_transcript_data',
           'get_transcript_info', 'get_conservation', 'get_exon_conservation', 'get_transcript_conservation',
           'get_transcript_conservation_safe', 'build_conservation_df', 'write_conservation_data']

# %% ../01_targetdata.ipynb #0d3192a4
import requests
import json
import pandas as pd
