# AUTOGENERATED! DO NOT EDIT! File to edit: ../03_predicttarg.ipynb.

# %% auto #0
__all__ = ['load_target_model', 'predict_target']

# %% ../03_predicttarg.ipynb #f040028f
from . import targetfeat
from .seq import load_booster_model

# %% ../03_predicttarg.ipynb #419b0208
